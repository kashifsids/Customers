...
[PostCode] [nvarchar] (15) COLLATE Latin1_General_CI_AS NOT NULL,
[ModifiedDate] [datetime] NOT NULL CONSTRAINT [DF__Address__Modifie__267ABA7A] DEFAULT (getdate())
) ON [PRIMARY]
GO
ALTER TABLE [Customer].[Address] ADD CONSTRAINT [PK__Address__091C2A1B8B10D1FE] PRIMARY KEY CLUSTERED  ([AddressID]) ON [PRIMARY]
GO
