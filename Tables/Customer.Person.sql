...
[FirstName] [varchar] (40) COLLATE Latin1_General_CI_AS NOT NULL,
[MiddleName] [varchar] (40) COLLATE Latin1_General_CI_AS NULL,
[LastName] [varchar] (40) COLLATE Latin1_General_CI_AS NOT NULL,
[Suffix] [nvarchar] (10) COLLATE Latin1_General_CI_AS NULL,
[ModifiedDate] [datetime] NOT NULL CONSTRAINT [DF__Person__Modified__239E4DCF] DEFAULT (getdate())
) ON [PRIMARY]
GO
ALTER TABLE [Customer].[Person] ADD CONSTRAINT [PK__Person__543B44870384991D] PRIMARY KEY CLUSTERED  ([person_ID]) ON [PRIMARY]
GO
